...
build_ffmpeg() {
  ...
  cd $output_dir
    ...
    if [[ $enable_gpl == 'y' ]]; then
      config_options+=" --enable-gpl --enable-avisynth --enable-frei0r --enable-filter=frei0r --enable-librubberband --enable-libvidstab --enable-libx264 --enable-libx265 --enable-libxavs --enable-libxvid --disable-encoders --disable-muxers --enable-muxer=mpegts --enable-muxer=matroska --enable-muxer=mp4 --enable-encoder=flac --enable-encoder=libx264 --enable-encoder=libopus --enable-encoder=aac --enable-encoder=libvpx_vp9 --disable-hwaccels --enable-encoder=ssa --enable-encoder=ass --enable-encoder=dvbsub --enable-encoder=dvdsub --enable-encoder=mov_text --enable-encoder=srt --enable-encoder=subrip --enable-encoder=text --enable-encoder=webvtt --enable-encoder=xsub"
    fi
