...
build_libutvideo() {
  download_and_unpack_file https://github.com/downloads/rdp/FFmpeg/utvideo-11.1.1-src.zip utvideo-11.1.1 # local copy since the originating site http://umezawa.dyndns.info/archive/utvideo is sometimes inaccessible
  cd utvideo-11.1.1
