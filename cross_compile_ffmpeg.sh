...
while true; do
  case $1 in
    -h | --help ) echo "available option=default_value:
      ...
      --fdk-aac-git-checkout-version=[master] if you want to build a particular version of fdk-aac, ex: --fdk-aac-git-checkout-version=v2.0.1 or a specific git hash
